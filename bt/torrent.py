...
class Torrent(object):
    def __init__(self, file_name, info_dict=None):
        ...
        self.info_hash = util.sha1_hash(bencode.bencode(self.info_dict['info']))
        ...
        """
        self.pieces = [(Piece(self, i, self.pieces_hashes[i]), []) for i in range(self.num_pieces)]
